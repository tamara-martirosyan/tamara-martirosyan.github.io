...
export const metadata: Metadata = {
  title: "Selected work",
  description: `Case studies from ${site.name} — AI collaboration platforms and complex enterprise workspaces.`,
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Case studies from products built end to end: TeamWorker.ai and DITAToo Web.",
      ...
      <main className="flex-1 px-5 py-16 md:px-8 md:py-24">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-foreground/70">
            Deep dives into products I lead and ship — from AI marketplaces to
            enterprise authoring workspaces.
          </p>
